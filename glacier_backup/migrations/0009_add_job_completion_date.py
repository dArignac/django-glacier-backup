...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryRetrievalJob.date_completion'
        db.add_column(u'glacier_backup_inventoryretrievaljob', 'date_completion',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchiveRetrievalJob.date_completion'
        db.add_column(u'glacier_backup_archiveretrievaljob', 'date_completion',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryRetrievalJob.date_completion'
        db.delete_column(u'glacier_backup_inventoryretrievaljob', 'date_completion')

        # Deleting field 'ArchiveRetrievalJob.date_completion'
        db.delete_column(u'glacier_backup_archiveretrievaljob', 'date_completion')
