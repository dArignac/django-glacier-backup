...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlacierBackup.status'
        db.add_column(u'glacier_backup_glacierbackup', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlacierBackup.status'
        db.delete_column(u'glacier_backup_glacierbackup', 'status')
